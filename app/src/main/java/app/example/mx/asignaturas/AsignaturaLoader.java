 ...
 */
public class AsignaturaLoader extends AsyncTaskLoader<Cursor> {
    ...
    public AsignaturaLoader(@NonNull Context context, long idAsignatura) {
        super(context);
    ...
    public Cursor loadInBackground() {
        ...
        Cursor cursor = AsignaturasDatabase.devuelveConId(context, asignaturaId);
    ...
    public static class asignaturasObserver extends BroadcastReceiver {
        private final AsignaturaLoader loader;

        public asignaturasObserver(AsignaturaLoader loader) {
            this.loader = loader;
        }
        ...
        public void register(){
            ...
            IntentFilter filter = new IntentFilter(AsignaturasLoader.ACTION_RELOAD_TABLE);
